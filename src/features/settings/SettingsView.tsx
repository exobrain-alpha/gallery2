...
import type { DedupeSummary, ExtensionRepairSummary, ScanSummary, SettingsState } from "../../types";
import {
  formatCount,
  formatDedupeSummary,
  formatErrorMessage,
      ...
      <section className="settings-panel">
        ...
        <div className="settings-actions">
          ...
          <div className="settings-action-buttons">
            ...
            <button className="primary-button" type="button" disabled={!dirty} onClick={handleSave}>保存</button>
          </div>
        </div>
      </section>
    </main>
